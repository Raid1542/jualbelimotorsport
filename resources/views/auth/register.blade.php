...
<body class="bg-gray-100 flex items-center justify-center min-h-screen text-gray-800">
  ...
  <div class="bg-white p-10 rounded-2xl shadow-xl w-full max-w-sm">
    ...
    <h2 class="text-center text-2xl font-bold text-[#ffbf29] mb-8">Daftar Akun</h2>
    ...
    <p class="text-center mt-6 text-sm">
      Sudah punya akun? 
      <a href="{{ route('login') }}" class="text-[#ffbf29] font-semibold hover:underline">Masuk di sini</a>
    </p>
  </div>
