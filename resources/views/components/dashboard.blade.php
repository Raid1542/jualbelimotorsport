    ...
    <div class="flex items-center space-x-4">
      ...
      <form action="{{ route('produk') }}" method="GET" class="relative mr-1">
        <input type="text" name="keyword" value="{{ request('keyword') }}" placeholder="Cari produk..."
          class="border border-gray-300 rounded-full py-1.5 pl-4 pr-10 text-sm w-48
                 text-gray-700 shadow-inner transition
                 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500
                 hover:border-yellow-400 hover:ring-yellow-100"
          id="searchInput">
      ...
      <div class="relative group">
        <button class="hover:text-yellow-800 transition relative focus:outline-none">
        ...
        {{-- Panel Dropdown Isi Keranjang --}}
        <div class="absolute right-0 mt-2 w-80 bg-white border rounded-lg shadow-lg z-50 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
