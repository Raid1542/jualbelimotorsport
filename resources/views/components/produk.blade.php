...
<nav class="bg-white shadow-md sticky top-0 z-50">
  <div class="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between relative">
    ...
    <div class="flex items-center space-x-3">
      ...
      <a href="{{ $logoLink }}" class="text-xl font-extrabold text-yellow-500">Speedzone</a>
    </div>
    ...
    {{-- Kanan: Tombol pencarian (mobile) & keranjang --}}
    <div class="flex items-center space-x-4">
      {{-- Tombol pencarian untuk mobile --}}
      <button id="search-toggle" class="md:hidden focus:outline-none">
  ...
  {{-- Kolom pencarian untuk HP (hidden by default) --}}
