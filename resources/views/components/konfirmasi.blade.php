<header class="bg-white shadow-md sticky top-0 z-50 px-4 py-4">
  <div class="relative flex items-center justify-center">
    ...
    <!-- Kiri: Logo & Nama (diperkecil) -->
    <a href="{{ route('keranjang.index') }}" class="absolute left-4 flex items-center space-x-3">
    ...
    <h1 class="text-2xl md:text-3xl font-extrabold text-yellow-500 text-center">Pembayaran</h1>
