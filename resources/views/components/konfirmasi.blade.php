<header class="bg-yellow-400 shadow-md sticky top-0 z-50">
  <div class="max-w-7xl mx-auto px-6 py-6 flex items-center justify-between relative min-h-[80px]">
    ...
    <a href="{{ route('keranjang.index') }}" class="absolute left-4 text-white hover:text-yellow-800 transition-transform transform hover:scale-110 text-lg font-medium flex items-center">
