...
<section class="h-screen bg-cover bg-center bg-no-repeat relative" 
  ...
  />
        ...
        <div class="mt-8 flex flex-wrap gap-4 justify-center md:justify-start">
          <a href="produk" class="bg-yellow-500 text-white font-bold px-8 py-4 rounded-full hover:bg-yellow-600 transition-all duration-300 shadow-lg hover:scale-110">
            Lihat Produk
          </a>
        </div>
      </div>
...
<section id="product" class="bg-gray-50 py-20">
  <div class="max-w-7xl mx-auto px-6 lg:px-12">
    ...
    <div class="grid md:grid-cols-3 gap-10">
      @foreach ([
  ['id' => 1, 'img' => '/images/Yamaha.jpg', 'nama' => 'Yamaha R15 V4', 'harga' => '38000000'],
  ['id' => 2, 'img' => '/images/Honda.jpg', 'nama' => 'Honda CBR250RR', 'harga' => '62000000'],
  ['id' => 3, 'img' => '/images/Ducati.jpg', 'nama' => 'Ducati Panigale V4', 'harga' => '799000000']
] as $item)
